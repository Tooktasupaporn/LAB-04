...
ผลที่ได้จากการทดลอง เป็นอย่างที่นักศึกษาคิดหรือไม่ อย่างไร  จงอธิบาย
 ...
 ไม่เป็นไปตามที่คิดเพราะไม่ทราบว่าคำสั่ง Console.Write() จะเป็นคำสั่งอะไร
<hr>
<hr>
<hr>
<hr>
...
-คำสั่ง Console.Write() เป็นคำสั่งให้แสดงคำตามที่เราจะให้แสดงออกมาโดยไม่มีเว้นวรรคและออกมาอยู่ในบรรทัดเดียวกัน
-คำสั่ง Console.WriteLine() เป็นคำสั่งที่แสดงคำตามที่เราจะให้แสดงออกมาโดยจะแสดงทีละบรรทัด
<hr>
<hr>
<hr>
...
-จากการทดลองพบว่า คำสั่ง Console.Write() เป็นคำสั่งให้แสดงคำตามที่เราจะให้แสดงออกมาโดยไม่มีเว้นวรรคและออกมาอยู่ในบรรทัดเดียวกัน และ คำสั่ง Console.WriteLine() เป็นคำสั่งที่แสดงคำตามที่เราจะให้แสดงออกมาโดยจะแสดงทีละบรรทัด
<hr>
<hr>
<hr>
<hr>
