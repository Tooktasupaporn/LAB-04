...
<hr>-เป็นตามที่คิด เพราะจะออกเป็นคำว่า world กับคำว่า Hello 
<hr>
<hr>
<hr>
<hr>
 ...
 * สั่ง Run โปรแกรมและบันทึกผลที่ได้จากการรันโปรแกรม
 ![](https://github.com/Tooktasupaporn/LAB-04/blob/master/imgs/project4-3.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
<hr> ไม่เป็นไปตามที่คิดเพราะไม่ทราบว่าคำสั่ง Console.Write() จะเป็นคำสั่งอะไร
<hr>
<hr>
<hr>
<hr>
...
<hr>-คำสั่ง Console.Write() เป็นคำสั่งให้แสดงคำตามที่เราจะให้แสดงออกมาโดยไม่มีเว้นวรรคและออกมาอยู่ในบรรทัดเดียวกัน
<hr>-คำสั่ง Console.WriteLine() เป็นคำสั่งที่แสดงคำตามที่เราจะให้แสดงออกมาโดยจะแสดงทีละบรรทัด
<hr>
<hr>
<hr>
...
<hr>-จากการทดลองพบว่า คำสั่ง Console.Write() เป็นคำสั่งให้แสดงคำตามที่เราจะให้แสดงออกมาโดยไม่มีเว้นวรรคและออกมาอยู่ในบรรทัดเดียวกัน และ คำสั่ง <hr>Console.WriteLine() เป็นคำสั่งที่แสดงคำตามที่เราจะให้แสดงออกมาโดยจะแสดงทีละบรรทัด
<hr>
<hr>
<hr>
<hr>
